...
- **攻撃のやり方：**
  ...
  3. ダメージ計算の結果、**相手カードのHPが1以上残った場合**は、次の処理を行います。
     ...
     >例：相手の♥6（HP6）のカードに、自分の♠5（パワー5）のカードが攻撃して「6-5=1」となった場合、♥6のカードを相手の変えカードの山に加え、相手はその山からA（HP1）のカードを引き出して同じマスに置きます。
        ...
        ![HPが残った場合の攻撃後の図3](assets/images/attack_remain_3_1.svg) 図11-3  
  ...
  4. **攻撃を受けても倒されなかった相手カードは反撃します。**
     ...
     ![反撃の流れを示す図](assets/images/attack_counter.svg) 図12  
...
4のカードは、そのマスから**2マス以内**の相手のカード1枚に魔法による効果を与えることができます。  
  ...
  ![4のカードが2マス以内の魔法効果の範囲を示す図](assets/images/special_4_range.svg) 図13  

- **相手カードのランクを半分に！**：  
  この能力を使うと、相手のカードのランクを**半分**にします。  

  ![4のカードで半減する前の図1](assets/images/special_4_attack_1_arrow.svg) 図14-1  
  
  ![4のカードで半減した後の図2](assets/images/special_4_attack_2.svg) 図14-2  
...
自分のAのカードとほかの自分のカードを「入れかえ」するとき、Aのカードは入れかえたカードのランクを**2倍**に回復することができます。  
  ...
  ![Aのカードで回復する前の図1](assets/images/special_a_heal_1_arrow.svg) 図15-1  

  ![Aのカードで回復した後の図2](assets/images/special_a_heal_2.svg) 図15-2  
